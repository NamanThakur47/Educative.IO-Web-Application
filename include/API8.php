    ...
    <div class="container-fluid col-md-11  ">
        <div class="row ">
                <div class="content col-md-9  ">
                    <h2 class="h2 p-3   float-start">Integrated Java Co Foundation Course</h2><br>
            ...
            <div>
              ...
              <div class="flex items-center justify-left m-2">
                <div class="flex items-center w-full">
                  ...
                  <p name="CollectionTitle" class="text-xl m-0  pb-2 pe-2 pt-2 font-bold text-left dark:text-dark-contrastText  " style="color:black; font-weight:500; font-size:18px; font-family:Poppins,sans-serif;">Integrated Java Co Foundation Course</p>
